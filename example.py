...
class Window2:
    ...
    def __init__(self, master):
        ...
        def clickbutton(self, value):
            """Handles number/operator button clicks."""
        ...
        def equals(self):
            ...
            try:
                # Replace unicode division and multiplication with Python operators
                expression = self.operator.replace('÷', '/').replace('x', '*')
                result = str(eval(expression))
                self.value.set(result)
                self.txtDisplay.delete(0, END)
                self.txtDisplay.insert(END, result)
                self.operator = result  # Allow further calculations
            except Exception:
        ...
        #===== calculator entry =========================================================================================================
        self.txtDisplay = Entry(self.calculator_frame, font="arial 20 bold", justify="right", bd=5, bg="powder blue")
        self.txtDisplay.grid(columnspan=7, sticky="ew")
        ...
        for j in range(5):  # 5 rows (including the display row)
            self.calculator_frame.grid_rowconfigure(j, weight=1)

        self.btn_one = Button(self.calculator_frame, text="1", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(1))
        self.btn_one.grid(row=1, column=0, sticky="nsew")

        self.gap_1 = Label(self.calculator_frame, text="")
        self.gap_1.grid(row=1, column=1)

        self.btn_two = Button(self.calculator_frame, text="2", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(2))
        self.btn_two.grid(row=1, column=2, sticky="nsew")

        self.gap_2 = Label(self.calculator_frame, text="")
        self.gap_2.grid(row=1, column=3)

        self.btn_three = Button(self.calculator_frame, text="3", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(3))
        self.btn_three.grid(row=1, column=4, sticky="nsew")

        self.gap_3 = Label(self.calculator_frame, text="")
        self.gap_3.grid(row=1, column=5)

        self.btn_mult = Button(self.calculator_frame, text="x", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton('*'))
        self.btn_mult.grid(row=1, column=6, sticky="nsew")

        self.btn_four = Button(self.calculator_frame, text="4", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(4))
        self.btn_four.grid(row=2, column=0, sticky="nsew")

        self.gap_4 = Label(self.calculator_frame, text="")
        self.gap_4.grid(row=2, column=1)

        self.btn_five = Button(self.calculator_frame, text="5", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(5))
        self.btn_five.grid(row=2, column=2, sticky="nsew")

        self.gap_5 = Label(self.calculator_frame, text="")
        self.gap_5.grid(row=2, column=3)

        self.btn_six = Button(self.calculator_frame, text="6", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(6))
        self.btn_six.grid(row=2, column=4, sticky="nsew")

        self.gap_6 = Label(self.calculator_frame, text="")
        self.gap_6.grid(row=2, column=5)

        self.btn_div = Button(self.calculator_frame, text="÷", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton('/'))
        self.btn_div.grid(row=2, column=6, sticky="nsew")

        self.btn_seven = Button(self.calculator_frame, text="7", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(7))
        self.btn_seven.grid(row=3, column=0, sticky="nsew")

        self.gap_7 = Label(self.calculator_frame, text="")
        self.gap_7.grid(row=3, column=1)

        self.btn_eight = Button(self.calculator_frame, text="8", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(8))
        self.btn_eight.grid(row=3, column=2, sticky="nsew")

        self.gap_8 = Label(self.calculator_frame, text="")
        self.gap_8.grid(row=3, column=3)

        self.btn_nine = Button(self.calculator_frame, text="9", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(9))
        self.btn_nine.grid(row=3, column=4, sticky="nsew")

        self.gap_9 = Label(self.calculator_frame, text="")
        self.gap_9.grid(row=3, column=5)

        self.btn_sub = Button(self.calculator_frame, text="-", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton('-'))
        self.btn_sub.grid(row=3, column=6, sticky="nsew")

        self.btn_clear = Button(self.calculator_frame, text="⌫", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE)
        self.btn_clear.grid(row=4, column=0, sticky="nsew")

        self.gap_10 = Label(self.calculator_frame, text="")
        self.gap_10.grid(row=4, column=1)

        self.btn_zero = Button(self.calculator_frame, text="0", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton(0))
        self.btn_zero.grid(row=4, column=2, sticky="nsew")

        self.gap_11 = Label(self.calculator_frame, text="")
        self.gap_11.grid(row=4, column=3)

        self.btn_add = Button(self.calculator_frame, text="+", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE, command=lambda: self.clickbutton('+'))
        self.btn_add.grid(row=4, column=4, sticky="nsew")

        self.gap_12 = Label(self.calculator_frame, text="")
        self.gap_12.grid(row=4, column=5)

        self.btn_equals = Button(self.calculator_frame, text="=", fg="black", font=("Arial", 15, "bold"), bg="dodgerblue", padx=30, pady=5, relief=GROOVE)
        self.btn_equals.grid(row=4, column=6, sticky="nsew")
